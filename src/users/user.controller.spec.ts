...
describe('UserController', () => {
  ...
  it('must return a base64 encoded string, set the Content-Type header and send the base64 avatar as a buffer', async () => {
    const response = {
      setHeader: jest.fn(),
      send: jest.fn(),
    };
  ...
  it('must return success message from deletion', async () => {
